...
controller.player2.onButtonEvent(ControllerButton.A, ControllerButtonEvent.Pressed, function () {
    ...
    music.play(music.createSong(hex`0078000408020100001c00010a006400f401640000040000000000000000000000000005000004280004000800051d2024272a0c001000041d20242714001800031d20241c002000021d2024002800011d`), music.PlaybackMode.UntilDone)
})
...
mp.setPlayerSprite(mp.playerSelector(mp.PlayerNumber.Three), sprites.create(img`
    ...
    `, SpriteKind.Player))
mySprite = mp.getPlayerSprite(mp.playerSelector(mp.PlayerNumber.One))
let my_sprite2 = mp.getPlayerSprite(mp.playerSelector(mp.PlayerNumber.Two))
let mysprite3 = mp.getPlayerSprite(mp.playerSelector(mp.PlayerNumber.Three))
